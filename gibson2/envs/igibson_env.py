...
from gibson2.tasks.interactive_social_nav_random_task import InteractiveSocialNavRandomTask
...
class iGibsonEnv(BaseEnv):
    ...
    def load_task_setup(self):
        ...
        elif self.config['task'] == 'interactive_social_nav_random':
            self.task = InteractiveSocialNavRandomTask(self)
