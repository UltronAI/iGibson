...
def get_config():
    ...
    parser.add_argument("--user_name", type=str, default='fenggao',help="[for wandb usage], to specify user's name for simply collecting training data.")
    ...
    parser.add_argument('--render_gpu_ids', type=int, nargs="+",
                        default=[], help="which gpu is used to render")
    parser.add_argument('--eval_render_gpu_ids', type=int, nargs="+",
                        default=[], help="which gpu is used to render")
    parser.add_argument('--use_multi_gpu', action='store_true')
    # scene parameters
    parser.add_argument("--scene_ids", type=str, nargs="+", default=[])
    parser.add_argument("--eval_scene_ids", type=str, nargs="+", default=[])
    # model parameters
    ...
    parser.add_argument("--use_rgbd_input", action="store_true")
    parser.add_argument("--use_pretrained_model", action="store_true")
    parser.add_argument("--use_multi_stage_feature", action="store_true")
    parser.add_argument("--multi_stage_mode", type=int, default=0)
    # reward parameters
    parser.add_argument("--w_success", type=float, default=None)
    parser.add_argument("--w_potential", type=float, default=None)
    parser.add_argument("--w_interact", type=float, default=None)
    # representation parameters
    parser.add_argument("--to_tensor", type=str, default="global_pooling", 
                        choices=["global_pooling", "reshaping"])
